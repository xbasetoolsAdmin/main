...
<body class="them">
        ...
        <nav class="navbar navbar-expand-xl navbar  navbar-light " style="
            ...
            <div class="navbar-collapse collapse w-100 order-3 dual-collapse2 user_nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" style="color: var(--font-color);" href="#" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> XBASETOOL <i class="fa fa-user-secret"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" style="color: var(--font-color);" aria-labelledby="navbarDropdownPortfolio">
                            <a class="dropdown-item" data-title="Settings" href="settings">Settings <i class="fa fa-cog"></i>
                            </a>
                            <a class="dropdown-item" data-title="Orders" href="orders">Orders <span class="badge badge-success"> <span id="orders"></span>
                                    <i class="fa fa-shopping-cart"></i>
                            </a>
                            <a class="dropdown-item" data-title="Add Balance" href="add-balance">Add Balance <i class="fa fa-money-bill-alt"></i>
                            </a>
                            <a class="dropdown-item noAjax" href="logout" style="color: var(--font-color);">Logout <i class="fa fa-door-open"></i>
                            </a>
                        </div>
                    </li>
                </ul>
    ...
    <div class="row m-2 pt-3" style="color: var(--font-color); background-color: var(--color-card);">
        <div class="col-sm-12 table-responsive">
            <table id="example" class="display responsive table-hover" style="width:100%" style="color: var(--font-color); background-color: var(--color-card);">
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
