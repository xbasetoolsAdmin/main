...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="https://xBasetools.xyz/assets/ css/bootstrap.min.css" rel="stylesheet">
  <!-- Material Design Bootstrap -->
  <link href="https://xBasetools.xyz/assets/css/mdb.min.css" rel="stylesheet">
  <style type="text/css">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/adddons/flag.min.css" />
    <style>
        body {
            padding-top: 80px
        }
...
date_default_timezone_set('UTC');
include "includes/config.php";
if (!isset($_SESSION['sname']) and !isset($_SESSION['spass'])) {  header("location: login");
 exit();}
$usrid = mysqli_real_escape_string($dbcon, $_SESSION['sname']);
?>
<!doctype html>
...
function pageDiv(n,t,u,x){
  if(cntrlIsPressed){
    ...
    var obj = { Title: t, Url: u };
     if ( ("/"+obj.Url) != location.pathname) { if (x != 1) {history.pushState(obj, obj.Title, obj.Url);}
